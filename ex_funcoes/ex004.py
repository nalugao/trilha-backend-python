...
def conferencia_conversao(lista):
    for telefone in lista: 
        if type(telefone) != int:
            return 'A conversão não deu certo!'
    return 'Todos os números foram convertidos corretamente!'

telefones_convertidos = conversor_int(telefones)
print(conferencia_conversao(telefones_convertidos))
